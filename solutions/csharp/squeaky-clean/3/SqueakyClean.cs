...
{
    private static string ReplaceUnderscoresToUnderline(string identifier) => identifier.Replace(' ', '_');
    ...
    public static string Clean(string identifier) => OmitGreekLoweCaseLetters(OmitNonLetters(ConvertToCamelCase(ReplaceControlCharsWithCTRL(ReplaceUnderscoresToUnderline(identifier)))));
}
